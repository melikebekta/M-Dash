            ...
            <div class="relative flex min-h-screen items-center justify-center overflow-hidden">
                ...
                >
                    <div class="relative">
                        ...
                        />
                        <p class="mt-5 text-base dark:text-white">Aradığınız sayfa bulunamadı!
                        </p>
                        <a href="{{ route('login') }}" class="btn btn-gradient mx-auto !mt-7 w-max border-0 uppercase shadow-none">Giriş Yap</a>
                    </div>
                </div>
            </div>
