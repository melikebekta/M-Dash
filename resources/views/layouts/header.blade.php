...
<html lang="en" dir="ltr">
    <head>
        ...
        <title> @yield('title') | M-Dash</title>
    ...
    >
        ...
        <div class="main-container min-h-screen text-black dark:text-white-dark" :class="[$store.app.navbar]">
                ...
                >
                    <div class="h-full bg-white dark:bg-[#0e1726]">
                        <div class="flex items-center justify-between px-4 py-3">
                            <a href="{{ route('index') }}" class="main-logo flex shrink-0 items-center">
                                <img class="ml-[5px] w-8 flex-none" src="assets/images/logo.svg" alt="image" />
                                <span class="align-middle text-2xl font-semibold ltr:ml-1.5 rtl:mr-1.5 dark:text-white-light lg:inline">M-Dash</span>
                            </a>
                            <a
                                href="javascript:;"
                        ...
                        >
                            <li class="menu nav-item">
                                ...
                                <ul x-cloak x-show="activeDropdown === 'dashboard'" x-collapse class="sub-menu text-gray-500">
                                    <li>
                                        <a href="{{ route('index') }}" class="active">Analitik</a>
                                    </li>
                                </ul>
                            </li>
                                    ...
                                    <li class="menu nav-item">
                                        ...
                                        >
                                            <div class="flex items-center">
                                                ...
                                                <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Fatura</span>
                                            </div>
                            ...
                            <li class="menu nav-item">
                                ...
                                >
                                    <div class="flex items-center">
                                        ...
                                        <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Kullanıcı</span>
                                    </div>
                            ...
                            <li class="menu nav-item">
                                ...
                                >
                                    <div class="flex items-center">
                                        ...
                                        <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Giriş</span>
                                    </div>
                                ...
                                <ul x-cloak x-show="activeDropdown === 'authentication'" x-collapse class="sub-menu text-gray-500">
                                    <li>
                                        <a href="{{ route('login') }}" target="_blank">Giriş Yap</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('signup') }}" target="_blank">Kayıt Ol</a>
                                    </li>
                                </ul>
                            </li>
            ...
            <div class="main-content flex min-h-screen flex-col">
                            ...
                            >
                                ...
                                <div class="dropdown flex-shrink-0" x-data="dropdown" @click.outside="open = false">
                                    ...
                                    >
                                        ...
                                        <li>
                                            <a href="{{ route('userProfile') }}" class="dark:hover:text-white" @click="toggle">
                                                <svg
                ...
                <div class="dvanimation animate__animated p-6" :class="[$store.app.animation]"></div>
