                        ...
                        <div class="w-full max-w-[440px] lg:mt-16">
                            <div class="mb-10">
                                <h1 class="text-3xl font-extrabold uppercase !leading-snug text-primary md:text-4xl">
                                    Giriş Yap</h1>
                                <p class="text-base font-bold leading-normal text-white-dark">Giriş yapmak için
                            ...
                            <div class="text-center dark:text-white">
                                Hesabınız yok mu?
                                <a href="{{ route('signup') }}"
                                    class="uppercase text-primary underline transition hover:text-black dark:hover:text-white">Kayıt
                                    ol</a>
                            </div>
                        </div>
