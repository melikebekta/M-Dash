                        ...
                        <div class="mx-auto w-full max-w-[440px]">
                            <div class="mb-10">
                                <h1 class="text-3xl font-extrabold uppercase !leading-snug text-primary md:text-4xl">
                                    Kayıt Ol</h1>
                                <p class="text-base font-bold leading-normal text-white-dark">Kayıt olmak için
                                    e-postanızı ve şifrenizi girin</p>
                            </div>
                            <form class="space-y-5 dark:text-white" method="post" action="{{ route('signup.post') }}">
                                @csrf
                                <div>
                                    <label for="Name">Kullanıcı Adı</label>
                                    <div class="relative text-white-dark">
                                        <input id="Name" type="text" placeholder="Kullanıcı adınızı giriniz" name="name"
                            ...
                            <div class="text-center dark:text-white">
                                ...
                                <a href="{{ route('login') }}"
                                    class="uppercase text-primary underline transition hover:text-black dark:hover:text-white">Giriş
                                    Yap</a>
                            </div>
                        </div>
                    </div>
