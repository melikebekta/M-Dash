...
<html lang="en" dir="ltr">
    <head>
        ...
        <script defer src="{{ asset('assets/js/sw') }}"></script>
    </head>
                    ...
                    >
                        ...
                        <div class="relative flex w-full flex-col items-center justify-center gap-6 px-4 pb-16 pt-6 sm:px-6 lg:max-w-[667px]">
                            ...
                            <div class="w-full max-w-[440px] lg:mt-16">
                                <div class="mb-10">
                                    <h1 class="text-3xl font-extrabold uppercase !leading-snug text-primary md:text-4xl">Giriş Yap</h1>
                                    <p class="text-base font-bold leading-normal text-white-dark">Giriş yapmak için e-postanızı ve şifrenizi girin</p>
                                </div>
                                <form class="space-y-5 dark:text-white" method="post" action="{{route('login.post')}}" >
                                    ...
                                    <div>
                                        ...
                                        <div class="relative text-white-dark">
                                            <input id="Email" type="email" name="email" placeholder="E-posta adresinizi giriniz " class="form-input ps-10 placeholder:text-white-dark" />
